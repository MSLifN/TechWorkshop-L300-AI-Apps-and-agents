    ...
    try:
        while True:
            ...
            try:
                ...
                # Special case: interior_designer_create_image doesn't need an agent ID
                # because it directly calls the image creation API
                if agent_name == "interior_designer_create_image":
                    agent_selected = "interior_designer_create_image"  # Dummy value to pass the check
                else:
